...
export const defaultSuggestions: SuggestionCategory[] = [
  {
    ...
    items: [
      ...
      },
      {
        id: 'ai-chat',
        title: 'AI Chat',
        subtitle: 'Ask AI anything · `ai` or `?`',
        icon: Bot,
        iconSrc: `${APP_ICON}/ai_icon.svg`,
        category: 'suggestion',
        shortcut: 'Command',
      },
      {
        ...
        subtitle: 'Manage one-shot AI prompts',
        icon: Wand2,
        iconSrc: `${APP_ICON}/ai_icon.svg`,
        category: 'suggestion',
        shortcut: 'Command',
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: FilePlus,
        iconSrc: `${APP_ICON}/create_note_icons.svg`,
        category: 'command',
        shortcut: 'Command',
      },
      {
        ...
        icon: StickyNote,
        iconSrc: `${APP_ICON}/search_note_icons.svg`,
        category: 'command',
        shortcut: 'Command',
      },
      {
        ...
        subtitle: 'Developer',
        icon: Code,
        iconSrc: `${APP_ICON}/create_extension_icon.svg`,
        category: 'command',
        shortcut: 'Command',
      },
      {
        ...
        subtitle: 'Developer',
        icon: Package,
        iconSrc: `${APP_ICON}/manage_extensions_icon.svg`,
        category: 'command',
        shortcut: 'Command',
      },
      {
        id: 'custom-emojis',
        title: 'Custom Emojis',
        subtitle: 'Generate sticker-style emojis with AI',
        icon: Sparkles,
        iconSrc: `${APP_ICON}/emojis_icon.svg`,
        category: 'command',
      },
