...
use crate::utils::win32::get_foreground_app_name;
...
// `get_foreground_app_name` lives in `crate::utils::win32` (shared with the
// global snippet-expansion hook) — see the `use` import at the top of this
// file.
