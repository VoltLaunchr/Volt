 ...
 */
export type Settings = { general: GeneralSettings, appearance: AppearanceSettings, hotkeys: HotkeySettings, indexing: IndexingSettings, plugins: PluginSettings, shortcuts: ShortcutsSettings, shell: ShellSettings, };
