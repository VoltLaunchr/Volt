 ...
 *
 * Not managed (intentionally — these read the version at runtime):
 *   - src/features/settings/SettingsApp.tsx — reads via Tauri `getVersion()`
 *   - src/shared/constants/suggestions.ts — interpolates from i18n at render
 *   - src/i18n/locales/{en,fr}/common.json — subtitle is the template
 *     "v{{version}}", interpolated by `SuggestionsView.tsx` from the Tauri
...
// ---------------------------------------------------------------------------
// 3. public/changelog.json — latest entry must exist for the target version.
